...
export const detectNdjsonFields: (a: number, b: number) => any;
export const detectStructure: (a: number, b: number, c: number, d: number) => any;
export const detectXmlElements: (a: number, b: number) => any;
export const getSimdEnabled: () => number;
export const getThreadingEnabled: () => number;
export const get_threading_support_info: () => any;
